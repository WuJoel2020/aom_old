...
void TF_Init_Model(FRAME_TYPE frameType, int QP) {
	...
	Py_SetPythonHome(L"D:/Anaconda3/envs/tensorflow-gpu");

	Py_Initialize();
	Py_SetPath(
		L"D:/Anaconda3/envs/tensorflow-gpu/Lib;"
		L"D:/Anaconda3/envs/tensorflow-gpu/Lib/site-packages;"
		L"D:/Anaconda3/envs/tensorflow-gpu/DLLs");



	//Py_SetPythonHome(L"D:/Anaconda3/envs/tensorflow36");

	//Py_Initialize();
	//Py_SetPath(
	//    L"D:/Anaconda3/envs/tensorflow36/Lib;"
	//    L"D:/Anaconda3/envs/tensorflow36/Lib/site-packages;"
	//    L"D:/Anaconda3/envs/tensorflow36/DLLs");
	...
	//Py_SetPath(
	// L"D:/Anaconda3/Lib;"
	// L"D:/Anaconda3/Lib/site-packages;"
	// L"D:/Anaconda3/DLLs");
	...
	pMod = PyImport_ImportModule("cnn_n");
	if (!pMod) {
...
void TF_Init_Models(FRAME_TYPE frameType, int QP) {
	...
	//pParm = Py_BuildValue("(i)", frameType);
	PyEval_CallObject(load_model, NULL);  // 导入预训练的模型
}

uint8_t **TF_Predict(uint8_t *ppp, int height, int width, int stride, int QP, int frameType) {
